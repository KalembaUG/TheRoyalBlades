                    ...
                    <div className="row">
                        <div className="col-xl-6 col-md-12">
                            <div className="banner__left">
                                <div className="block-text">
                                    <h2 className="heading">Get Your Assets <br />
                                        For Royal Blades <span className="s1 arlo_tm_animation_text_word">Game</span> <br />
                                        Today</h2>
                                    <p className="desc">This is the royal blades market place for the royal blades in game assets</p>
                        ...
                        <div className="col-xl-6 col-md-12">
                            ...
                            <div className="banner__right">
                                <div className="image">
                                    <img src={img1} alt="Royal blades" />
                                </div>

                                <div className="price">
                                    <div className="icon">
                                        <img src={img2} alt="Royal blades" />
                                    </div>
