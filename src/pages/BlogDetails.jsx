                                    ...
                                    <div className="main">
                                        ...
                                        <div className="bottom">
                                            ...
                                            <ul className="list-tag">
                                                ...
                                                <li><Link to="/blog-details">Royal blades</Link></li>
                                ...
                                <div className="bottom">
                                    ...
                                    <div className="comment">
                                        ...
                                        <div className="comment-box s1">
                                            <div className="avt">
                                                <img src={avt1} alt="Royal blades" />
                                            </div>
                                            <div className="info">
                                                <h6 className="name">Annette Black</h6>
                                                <p className="meta">February 18, 2023</p>
