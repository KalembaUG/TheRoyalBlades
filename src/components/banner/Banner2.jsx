...
function Banner2(props) {
    ...
    const [dataBlock] = useState(
        {
            subheading: 'Play To Earn',
            heading: 'Royal Blades Market Place',
            desc:'This is the royal blades official market place for Land in game Assets and more you will find in the Royal Blades game.'
        }
    )
    return (
