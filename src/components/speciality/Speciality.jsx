...
function Speciality(props) {
    ...
    const [dataBlock] = useState(
        {
            subheading: 'Our goal',
            heading: 'Complete Solutions for royal blades game assets',
            desc: 'This is the royal blades official market place for Land ingame Assets and more you will find in the Royal Blades game.' ,
